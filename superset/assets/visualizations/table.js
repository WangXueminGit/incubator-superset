        ...
        .attr('class', function(d) {
            ...
            if (d.coloringOption !== null) {
                if (d.coloringOption === 'seagreen') {
                    coloringOptionClass = 'backcolorlightseagreen'
                } else if (d.coloringOption === 'lightpink') {
                    coloringOptionClass = 'backcolorlightpink'
                } else if (d.coloringOption === 'lightblue') {
                    coloringOptionClass = 'backcolorlightblue'
                } else if (d.coloringOption === 'beige') {
                    coloringOptionClass = 'backcolorbeige'
                } else if (d.coloringOption === 'lightgray') {
                    coloringOptionClass = 'backcolorlightgray'
                }
            }
            if (d.bcColoringOption !== null) {
                if (d.bcColoringOption === 'seagreen') {
                    bcColoringOptionClass = 'backcolorlightseagreen'
                } else if (d.bcColoringOption === 'lightpink') {
                    bcColoringOptionClass = 'backcolorlightpink'
                } else if (d.bcColoringOption === 'lightblue') {
                    bcColoringOptionClass = 'backcolorlightblue'
                } else if (d.bcColoringOption === 'beige') {
                    bcColoringOptionClass = 'backcolorbeige'
                } else if (d.bcColoringOption === 'lightgray') {
                    bcColoringOptionClass = 'backcolorlightgray'
                }
            }
            if (d.fontOption !== null) {
                if (d.fontOption === 'Important bold') {
                    fontOptionClass = 'importantbold'
                } else if (d.fontOption === 'Just normal') {
                    fontOptionClass = 'justnormal'
                }
            }
